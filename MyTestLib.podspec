...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://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@github.com/abdomi7/MyTestLib.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'abdomi7' => '56141588+abdomi7@users.noreply.github.com' }
  s.source           = { :git => 'https://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@github.com/abdomi7/MyTestLib.git', :tag => s.version.to_s }
